...
export function TimePickerInput({
  ...
  return (
    <Input
      ...
      name={name || picker}
      className={cn(
        'focus:bg-accent focus:text-accent-foreground h-8 w-[30px] border-0 p-0 text-center tabular-nums caret-transparent focus-visible:ring-0 [&::-webkit-inner-spin-button]:appearance-none',
        className,
      )}
